...
const steps = [
  {
    num: "01",
    title: "Apply Online",
    desc: "Fill in the partner application — takes under 5 minutes. We review and respond within one business day.",
  },
  {
    num: "02",
    title: "Onboarding Call",
    desc: "A 45-minute call with your partner success manager to set up your account, access the portal, and agree your go-to-market plan.",
  },
  {
    num: "03",
    title: "Get Certified",
    desc: "Complete the free Webenablix Partner Certification course — typically 2 hours. All team members can certify at no extra cost.",
  },
  {
    num: "04",
    title: "Start Earning",
    desc: "Share your unique referral link or co-sell with our team. Commissions are tracked live and paid every 30 days.",
  },
];
...
const testimonials = [
  {
    quote:
      "We added Webenablix to every web project 18 months ago. It's now our #1 upsell — almost every client takes it — and the recurring commissions have added $120K ARR to our business.",
    name: "Rachel Kim",
  ...
  {
    quote:
      "The white-label option let us launch our own accessibility product in two weeks. We now have 60 clients on it, and none of them know the infrastructure is Webenablix — that's exactly what we needed.",
    name: "Tom Ashford",
    role: "CEO",
  ...
  {
    quote:
      "As a compliance consultancy, having an automated tool to back our recommendations has cut our audit time in half. The VPAT reports Webenablix generates are accepted by every government client we work with.",
    name: "Sunita Patel",
