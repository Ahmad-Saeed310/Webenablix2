...
const PricingPage = () => {
  ...
  useEffect(() => {
    const cleanup1 = injectSchema(pricingPageSchema, "pricing-page-schema");
    const cleanup2 = injectSchema(
      pricingBasicPlanSchema,
      "pricing-basic-plan-schema",
    );
    const cleanup3 = injectSchema(
      pricingSelfManagedPlanSchema,
      "pricing-self-managed-plan-schema",
    );
    const cleanup4 = injectSchema(
      pricingManagedPlanSchema,
      "pricing-managed-plan-schema",
    );
    ...
    const cleanup7 = injectSchema(pricingValueSchema, "pricing-value-schema");
    const cleanup8 = injectSchema(pricingFaqSchema, "pricing-faq-schema");
    const cleanup9 = injectSchema(pricingCtaSchema, "pricing-cta-schema");
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              From basic automation to fully managed services, we have a plan
              that fits your accessibility needs.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto items-start">
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
              ...
              <p className="mb-6 text-sm text-gray-600">
                Our basic plan for automation-only monitoring, fixes, and online
                support
              </p>
              <Button
                onClick={() => navigate("/register")}
                className="w-full rounded-full py-3 font-semibold mb-8 bg-[#2563EB] text-white hover:bg-[#1d4ed8]"
              >
            ...
            <div className="relative bg-[#2563EB] text-white rounded-2xl p-8 ring-4 ring-[#2563EB]/20 scale-105">
              ...
              <p className="mb-6 text-sm text-blue-100">
                Empower your developers to understand and build for
                accessibility at the source
              </p>
              <Button
                onClick={() => navigate("/register")}
                className="w-full rounded-full py-3 font-semibold mb-8 bg-white text-[#2563EB] hover:bg-gray-100"
              >
                Schedule Demo <ArrowRight className="w-4 h-4 ml-2" />
              </Button>
              <div>
                <p className="text-sm font-semibold mb-4 text-blue-200">
                  Features include:
                </p>
                <ul className="space-y-3">
                  {[
            ...
            <div className="bg-white rounded-2xl p-8 border border-gray-200">
              ...
              <p className="mb-6 text-sm text-gray-600">
                Let our team of experts get you compliant by handling everything
                for you
              </p>
              <Button
                onClick={() => navigate("/register")}
                variant="outline"
                className="w-full rounded-full py-3 font-semibold mb-8"
              >
                Schedule Demo <ArrowRight className="w-4 h-4 ml-2" />
              </Button>
              <div>
          ...
          <div className="mt-20">
            ...
            <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
              Our plans are flexible, allowing your company to choose what
              solutions you need.
            </p>
                    ...
                    <th className="text-center py-4 px-4 bg-blue-50">
                      ...
                      <div className="mt-2">
                        <Button
                          onClick={() => navigate("/register")}
                          size="sm"
                          className="rounded-full text-xs bg-[#2563EB]"
                        >
                          Schedule Demo
                        </Button>
                      </div>
                ...
                <tbody>
                  ...
                  <tr className="border-b border-gray-100">
                    <td className="py-3 px-4 text-gray-700">
                      Included after purchasing Expert Audits
                    </td>
                    <td className="py-3 px-4 text-center">
                      <X className="w-5 h-5 text-gray-300 mx-auto" />
                    </td>
