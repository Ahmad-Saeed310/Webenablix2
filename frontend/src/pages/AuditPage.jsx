...
const AuditPage = () => {
  ...
  useEffect(() => {
    // Inject main audit product schema
    const cleanup1 = injectSchema(auditPageMainSchema, "audit-product-schema");

    // Inject service offerings schema
    const cleanup2 = injectSchema(
      auditServiceOfferings,
      "audit-service-offerings-schema",
    );
    ...
    // Inject audit expertise schema
    const cleanup4 = injectSchema(
      auditExpertiseSchema,
      "audit-expertise-schema",
    );

    // Inject audit process schema (How-To)
    const cleanup5 = injectSchema(auditProcessSchema, "audit-process-schema");

    // Inject audit FAQ schema
    const cleanup6 = injectSchema(auditFaqSchema, "audit-faq-schema");

    // Inject audit benefits schema
    const cleanup7 = injectSchema(auditBenefitsSchema, "audit-benefits-schema");

    // Inject CTA schema
    const cleanup8 = injectSchema(auditCtaSchema, "audit-cta-schema");
        ...
        <section className="bg-gradient-to-b from-[#2563EB] to-[#3B82F6] py-20 lg:py-28">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white/80 max-w-3xl mx-auto mb-8">
              Get detailed reports on your website's ADA & WCAG compliance with
              actionable recommendations from certified accessibility experts.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:border-[#2563EB] hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600 mb-6">
                  AI-powered scanning that detects common accessibility issues
                  instantly.
                </p>
                ...
                <Button
                  ...
                  className="w-full bg-[#2563EB] hover:bg-[#1d4ed8] text-white rounded-full"
                >
                  Try Free Scan
                </Button>
              </div>
              ...
              <div className="bg-[#2563EB] rounded-2xl p-8 text-white relative">
                ...
                <p className="text-blue-100 mb-6">
                  Manual review by certified accessibility experts with detailed
                  recommendations.
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center gap-2">
                  ...
                  <li className="flex items-center gap-2">
                    <Check className="w-5 h-5 text-blue-200" />
                    <span className="text-sm">Compliance statement</span>
                  </li>
                </ul>
                <Button
                  onClick={() => navigate("/register")}
                  className="w-full bg-white text-[#2563EB] hover:bg-gray-100 rounded-full"
                >
                  Schedule Audit
                </Button>
              </div>
              ...
              <div className="bg-white rounded-2xl p-8 border border-gray-200 hover:border-[#2563EB] hover:shadow-xl transition-all">
                ...
                <p className="text-gray-600 mb-6">
                  Complete audit with remediation support and legal
                  documentation.
                </p>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center gap-2">
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600">
                Comprehensive checks based on WCAG 2.1 AA guidelines
              </p>
            </div>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="bg-white p-6 rounded-xl">
                ...
                <p className="text-sm text-gray-600">
                  Text alternatives, captions, color contrast, text resize
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl">
              ...
              <div className="bg-white p-6 rounded-xl">
                ...
                <p className="text-sm text-gray-600">
                  Readable content, predictable UI, input assistance
                </p>
              </div>
              <div className="bg-white p-6 rounded-xl">
        ...
        <section className="py-20 bg-gradient-to-r from-[#2563EB] to-[#3B82F6]">
          <div className="max-w-4xl mx-auto px-4 text-center">
            ...
            <p className="text-white/80 text-lg mb-8">
              Get a comprehensive audit and actionable roadmap to compliance
            </p>
            <Button
              onClick={() => navigate("/register")}
              className="bg-white text-[#2563EB] hover:bg-gray-100 rounded-full px-8 py-4 h-auto font-semibold"
