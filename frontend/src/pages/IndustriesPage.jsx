...
import { injectSchema, industriesPageSchema } from "../utils/schemaMarkup";
...
const industries = [
  {
    ...
    icon: Building,
    title: "Government",
    desc: "Make government websites accessible to all citizens",
  },
  {
    to: "/industries/banking",
    icon: Landmark,
    title: "Banking",
    desc: "Ensure financial services are available to everyone",
  },
  {
    to: "/industries/academic",
    icon: GraduationCap,
    title: "Academic",
    desc: "Create inclusive educational environments",
  },
  {
    to: "/industries/retail",
    icon: ShoppingCart,
    title: "Retail",
    desc: "Build accessible shopping experiences",
  },
  {
    to: "/industries/it",
    icon: Code,
    title: "IT",
    desc: "Implement accessibility across digital platforms",
  },
  {
    to: "/industries/healthcare",
    icon: HeartPulse,
    title: "HealthCare",
    desc: "Improve accessibility in healthcare services",
  },
  {
    to: "/industries/automotive",
    icon: Car,
    title: "Automotive",
    desc: "Ensure accessibility in automotive technology",
  },
  {
    to: "/industries/real-estate",
    icon: Home,
    title: "Real Estate",
    desc: "Make real estate listings accessible to everyone",
  },
  {
    to: "/industries/ngo",
    icon: Heart,
    title: "NGO/NPO",
    desc: "Support accessibility for nonprofit organizations",
  },
  {
    to: "/industries/media",
    icon: Tv,
    title: "Media & Entertainment",
    desc: "Provide inclusive media experience",
  },
  {
    to: "/industries/law-enforcement",
    icon: Shield,
    title: "Law Enforcement",
    desc: "Ensure accessibility in public safety services",
  },
];
        ...
        <section className="bg-gradient-to-b from-[#2563EB] to-[#3B82F6] py-20">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <p className="text-xl text-white/80 max-w-2xl mx-auto">
              Tailored accessibility solutions for every industry, ensuring
              compliance and inclusivity across all sectors.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="grid md:grid-cols-4 gap-8 text-center">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-2">Expert Support</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-20 bg-gradient-to-r from-[#2563EB] to-[#3B82F6]">
          <div className="max-w-4xl mx-auto px-4 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              Ready to Make Your Industry More Accessible?
            </h2>
            <p className="text-white/80 text-lg mb-8">
              Contact our team for industry-specific accessibility solutions
            </p>
            <Button
